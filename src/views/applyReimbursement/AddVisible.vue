		...
		<el-dialog title="提交报销" :visible.sync="FromVisible" width="30%" :before-close="rest">
			...
			>
				...
				<el-form-item label="报销二维码: " prop="payerQrcode">
					<Upload @func="imageQR" :imageUrl="formData.payerQrcode" :className="'avatar-uploader'" :extend="'.jpg,.png'" />
				</el-form-item>

				<el-form-item>
					<el-button type="primary" @click="addApply('formData')" size="mini">提交申请</el-button>
