<template>
  <div>
    <div id="canvas-container" class="canvas-container">
      <canvas v-for="page in pages" :id="'the-canvas'+page" :key="page" class="item" />
    </div>
    <div class="qian">
      <el-button v-if="flag" :disabled="!isControl" style="width: 200px;" type="success" @click="getContract()">生成合约</el-button>
    </div>
    <contract-empty :visible="visible" />
  </div>
</template>
<script>
